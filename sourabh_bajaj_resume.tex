...
\newenvironment{fourcolentry}[4][]{
    ...
    \switchcolumn \raggedleft \fourthColumn
    \end{paracol}
    \endonecolentry
} % new environment for four column entries
...
\section{Education}
  ...
  \begin{twocolentry}{
            \textbf{Birla Institute of Technology and Science}
        }  Pilani, India
        \end{twocolentry}
  \begin{onecolentry}{
